 ...
 * Time: 23:14:13<br>
 * Description:<br>
 * پروژه یوتیلیتی کمک کننده به پروژه های دیگر مایکروسرویسی دیگر اسپرینگ بوت
 * میتوان با اضافه کردن وابستگی این پروژه به پروژه اصلی از کلاسها و متدهای یوتیلیتی آن استفاده نمود
 * <p>
 * https://www.baeldung.com/spring-boot-dependency
 * https://maven.apache.org/guides/introduction/introduction-to-the-lifecycle.html
 * Using a Spring Boot Application as a Dependency :
 * to have new build:
 * 1.increase pom version tag (if you want to update current version delete folder c:\\users\\{myuser}\\.m2\\jparepository\\com\\motaharinia\\MsUtility)
