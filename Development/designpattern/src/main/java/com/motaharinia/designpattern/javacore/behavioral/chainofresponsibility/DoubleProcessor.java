...
public class DoubleProcessor implements Chain {
    ...
    public String process(Object objectNumber) {
        if (objectNumber != null && objectNumber instanceof Double) {
            Double number = (Double) objectNumber;
            return ("DoubleProcessor:" + number.toString());
        } else {
