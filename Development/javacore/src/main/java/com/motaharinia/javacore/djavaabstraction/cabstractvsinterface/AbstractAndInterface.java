...
//کلاس انتزاعی و رابط هر دو برای دستیابی به انتزاع مورد استفاده قرار می گیرند که می توانیم متدهای انتزاعی را اعلام کنیم.
//کلاس انتزاعی و رابط هر دو را نمی توان نمونه گیری کرد.
...
//1) کلاس انتزاعی می تواند دارای متدهای انتزاعی و غیر انتزاعی باشد.
// رابط فقط می تواند روشهای انتزاعی داشته باشد. از جاوا 8 ، رابط می تواند روش های پیش فرض و استاتیک نیز داشته باشد.
// 2) کلاس انتزاعی از ارث چندگانه پشتیبانی نمی کند. رابط از وراثت چندگانه پشتیبانی می کند.
// 3) کلاس انتزاعی می تواند متغیرهای نهایی ، غیر نهایی ، استاتیک و غیر استاتیک داشته باشد. رابط فقط متغیرهای استاتیک و نهایی دارد.
// 4) کلاس انتزاعی می تواند اجرای رابط را فراهم کند. رابط نمی تواند اجرای کلاس انتزاعی را فراهم کند.
// 5) کلمه کلیدی abstract برای اعلام کلاس انتزاعی استفاده می شود. کلمه کلیدی interface برای اعلام رابط استفاده می شود.
// 6) یک کلاس انتزاعی می تواند کلاس جاوا دیگری را extend کند و چندین رابط جاوا را پیاده سازی کند. یک رابط فقط یک رابط جاوا دیگر می تواند extend کند.
