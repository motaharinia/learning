...
//Block
//Nested class
//کلمه کلیدی static در جاوا عمدتا برای مدیریت حافظه استفاده می شود. ما می توانیم کلمات کلیدی static را برای متغیرها ، متد ها ، بلوک ها و کلاس هایinner قرار دهیم.
