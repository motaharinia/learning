...
// از جاوا 8 ، می توانیم متد های پیش فرض و استاتیک را در یک رابط داشته باشیم.
// از جاوا 9 ، می توانیم متد خصوصی را در یک رابط داشته باشیم.
//
...
// یعنی تمام متد های موجود در یک رابط با بدنه خالی اعلام می شوند ، و تمام فیلد ها بصورت پیش فرض عمومی ، استاتیک و نهایی هستند.
