...
//اگر زیر کلاس (کلاس کودک) همان روشی را که در کلاس والدین اعلام شده است داشته باشد ، به عنوان روشی که در جاوا مشهور است شناخته می شود.
//به عبارت دیگر ، اگر یک زیر کلاس اجرای خاصی از روشی را که توسط یکی از کلاسهای والدین خود اعلام شده است فراهم کند ، به عنوان روش اصلی شناخته می شود.
//روش اصلی برای ارائه اجرای خاص روشی که قبلاً توسط ابر کلاس آن ارائه شده است ، استفاده می شود.
//روش غلبه بر روش چندشکلی در زمان اجرا استفاده می شود
//
