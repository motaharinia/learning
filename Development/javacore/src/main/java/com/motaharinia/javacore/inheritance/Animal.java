...
//اگر کلاس A و B یک روش را داشته باشد و شما آن را از کلاس کلاس کودک بنامید ، ابهام وجود خواهد داشت که از روش کلاس A یا B استفاده کنید.
//از آنجا که خطاهای زمان کامپایل بهتر از خطاهای زمان اجرا هستند ، اگر 2 کلاس را به ارث ببرید ، جاوا را خطا وارد می کند.
//بنابراین چه شما یک روش مشابه داشته باشید و چه متفاوت ، خطای زمانی کامپایل وجود خواهد داشت.
public class Animal {
    //میزان انرژی حیوان
