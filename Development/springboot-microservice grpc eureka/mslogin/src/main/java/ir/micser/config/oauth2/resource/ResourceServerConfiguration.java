...
//        String[] openAuthenticationUriArray = OpenUriConfig.getOpenUriAuthenticationArray();
        String[] openAuthenticationUriArray = new String[]{"/","/error**","/actuator/**","/v1/employee/async/**", "/v1/captchaCode/**","/v1/adminUser**","/v1/adminUser/**","/v1/etcItem**","/v1/getCombo**","/v1/adminUserOrganizationUnit/**","/v1/buildIndexRun/**"};
        http.cors().and()
                .authorizeRequests()
